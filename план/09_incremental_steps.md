...
- [x] Увеличен масштаб игрока на 15% (0.54 -> 0.621) для баланса с врагами
...
- Анимация разрыва ленты работает ✅
...
- ✅ Счёт отображается
- ✅ Обновление работает
- ✅ PayPal подложка используется
- ✅ Позиционирование соответствует оригиналу
...
**Задачи:**
- [x] Создать Tutorial Overlay
- [x] Показ при первом запуске (состояние INTRO)
- [x] Отображение текста "Tap to start earning!" с переносом строки
- [x] Использование шрифта GameFont из asset_0045.ttf
- [x] Скрытие после клика (переход в RUNNING)
- [x] Анимация fade in/out
- [x] Показ туториала перед первым врагом ("Jump to avoid\nenemies")
- [x] Пауза игры при показе туториала про врага
- [x] Остановка анимаций игрока и врага при паузе
- [x] Автоматический прыжок при возобновлении после туториала про врага
- [x] Отключение прыжков до появления туториала про врага

**Результат**: Туториал показывается при старте игры и перед первым врагом

**Тест**:
- Туториал показывается при состоянии INTRO ✅
- Текст "Tap to start earning!" отображается с правильным шрифтом ✅
- Туториал "Jump to avoid enemies" появляется перед первым врагом ✅
- Игра паузится, игрок и враг останавливаются ✅
- При тапе игра возобновляется, игрок прыгает ✅
- Прыжки отключены до появления туториала про врага ✅
- Скрытие работает при клике ✅
- Анимация плавная ✅
- Текст читаемый (белый с черной обводкой) ✅

**Критерии готовности:**
- ✅ Туториал работает
- ✅ Показывается при старте
- ✅ Показывается перед первым врагом
...
**Задачи:**
- [x] Создать End Overlay (победа) - WinEndScreen
- [x] Создать Fail Overlay (поражение) - FailEndScreen
- [x] Создать Lose Screen (промежуточный экран проигрыша) - LoseScreen
- [x] Показ при завершении игры
- [x] Отображение финального счёта
- [x] CTA кнопка "INSTALL AND EARN!"
...
- Счёт отображается ✅
- Кнопки работают ✅
- LoseScreen показывает asset_0041.png с анимацией расширения ✅
- WinEndScreen показывает PayPal карточку с суммой и кнопкой ✅
- FailEndScreen показывает финальный экран проигрыша ✅
...
**Задачи:**
- [x] Интегрировать Howler.js
- [x] Создать AudioManager для управления звуками
- [x] Загрузить звуковые эффекты
- [x] Звук прыжка (asset_0030.mp3)
- [x] Звук сбора монетки (asset_0033.mp3)
- [x] Звук урона/столкновения (asset_0032.mp3)
- [x] Звук финала (asset_0035.mp3)
- [x] Фоновая музыка (asset_0037.mp3, зациклена)
- [x] Обработка разблокировки аудио для браузеров
- [x] Пауза/возобновление музыки при туториале
...
- Нет задержек ✅
- Фоновая музыка запускается при старте игры ✅
- Звук прыжка срабатывает при каждом прыжке ✅
- Звук сбора срабатывает при подборе денег ✅
- Звук столкновения срабатывает при уроне ✅
- Звук финала срабатывает при победе ✅

**Критерии готовности:**
- ✅ Звуки работают
- ✅ Качество хорошее
- ✅ Все звуки интегрированы в игровые события
