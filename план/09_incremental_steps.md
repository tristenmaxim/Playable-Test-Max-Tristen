...
- [ ] Игрок idle при паузе (будет реализовано позже)
...
**Задачи:**
- [x] Монетки статичные (стоят на месте) - изменено: коллектблы не движутся
...
**Результат**: Монетки стоят на месте и собираются при касании

**Тест**:
- Монетки статичные (стоят на месте) ✅
